...
private:
	...
	STEAM_CALLBACK(FOnlineAsyncTaskManagerSteam, OnMicroTxnAuthorizationResponse, MicroTxnAuthorizationResponse_t , OnMicroTxnAuthorizationResponseCallback);
...
public:
	...
	FOnlineAsyncTaskManagerSteam(class FOnlineSubsystemSteam* InOnlineSubsystem) :
		...
		OnMicroTxnAuthorizationResponseCallback(this, &FOnlineAsyncTaskManagerSteam::OnMicroTxnAuthorizationResponse),
