...
public:
	...
	UTexture2D* GetUserImage()const;

	void SetUserImage(uint8 *_pAvatarRGBA,uint32 _uAvatarWidth,uint32 _uAvatarHeight)
	{
		if(this->pAvatarRGBA!=nullptr)
		{
			delete []this->pAvatarRGBA;
			this->pAvatarRGBA = nullptr;
		}
		this->pAvatarRGBA = _pAvatarRGBA;
		this->uAvatarWidth = _uAvatarWidth;
		this->uAvatarHeight = _uAvatarHeight;
	}
