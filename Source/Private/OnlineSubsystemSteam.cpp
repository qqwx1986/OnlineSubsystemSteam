...
static TMap<FString, FString> SteamLanguage{
	{TEXT("arabic"),TEXT("ar")},
	{TEXT("bulgarian"),TEXT("bg")},
	{TEXT("schinese"),TEXT("zh-CN")},
	{TEXT("tchinese"),TEXT("zh-TW")},
	{TEXT("czech"),TEXT("cs")},
	{TEXT("danish"),TEXT("da")},
	{TEXT("dutch"),TEXT("nl")},
	...
	{TEXT("vietnamese"),TEXT("vn")},
};
FString FOnlineSubsystemSteam::GetLanguage() const
{
	FString CurrentLanguage(UTF8_TO_TCHAR(SteamApps()->GetCurrentGameLanguage()));
	auto Language = SteamLanguage.Find(CurrentLanguage);
	if(Language)
	{
...
FString FOnlineSubsystemSteam::GetUILanguage() const
{
	FString UILanguage(UTF8_TO_TCHAR(SteamUtils()->GetSteamUILanguage()));
	auto Language = SteamLanguage.Find(UILanguage);
	if(Language)
	{
		UILanguage = *Language;
	}
