...
DECLARE_MULTICAST_DELEGATE_OneParam(FOnSteamInvitedToGame, FString /* StrInviteeParam */);
typedef FOnSteamInvitedToGame::FDelegate FOnSteamInvitedToGameDelegate;

DECLARE_MULTICAST_DELEGATE_TwoParams(FOnSteamMicroTxnAuthorizationResponse, uint64 /* nOrderId */,bool /* bConfirm */);
typedef FOnSteamMicroTxnAuthorizationResponse::FDelegate FOnSteamMicroTxnAuthorizationResponseDelegate;
...
public:
	...
	DEFINE_ONLINE_DELEGATE_ONE_PARAM(OnSteamInvitedToGame, FString);
	
	DEFINE_ONLINE_DELEGATE_TWO_PARAM(OnSteamMicroTxnAuthorizationResponse, uint64, bool);
};
